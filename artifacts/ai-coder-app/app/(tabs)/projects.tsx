...
const styles = StyleSheet.create({
  ...
  glowTop: { position: 'absolute', top: -60, right: -60, width: 240, height: 240, borderRadius: 120, opacity: 0.35 },
  glowBottom: { position: 'absolute', bottom: 100, left: -40, width: 180, height: 180, borderRadius: 90, opacity: 0.25 },
  ...
  newCard: {},
  cardGlow: { position: 'absolute', bottom: -20, left: '20%', width: 140, height: 60, borderRadius: 70, opacity: 0.3 },
  newGlow: { position: 'absolute', top: -10, right: 20, width: 80, height: 80, borderRadius: 40, opacity: 0.4 },
  ...
  repoInput: { flex: 1, fontSize: 13, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, borderWidth: 1 },
  ...
  sectionLabel: { fontSize: 11, letterSpacing: 2, fontWeight: '700', marginBottom: 12, marginTop: 4 },
  emptyText: { fontSize: 14, textAlign: 'center', marginTop: 40, lineHeight: 22 },
});
